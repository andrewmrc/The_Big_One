...
namespace UnityStandardAssets.Cameras
{
    public class ProtectCameraFromWallClip : MonoBehaviour
    {
		...
		private Vector3 m_Pivot_Origin;         // the origin point at which the camera pivots around
        ...
        private void Start()
        {
			...
			m_Pivot_Origin = new Vector3(0, 1.5f, 0);
        ...
        private void LateUpdate()
        {
			...
			if (hitSomething) {
				...
				//m_Pivot.localPosition = new Vector3 (0, 1.3f, 0);

			} else {
				//m_Pivot.localPosition = new Vector3 (0.3f, 1.1f, 0);
			}
